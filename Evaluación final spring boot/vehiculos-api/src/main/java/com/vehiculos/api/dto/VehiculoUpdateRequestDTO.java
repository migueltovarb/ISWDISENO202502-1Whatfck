...
public class VehiculoUpdateRequestDTO {
    ...
    // Constructores
    public VehiculoUpdateRequestDTO() {
    }

    public VehiculoUpdateRequestDTO(String marca, String modelo, Integer año, String placa, Double precio, String tipo, Boolean disponible) {
        this.marca = marca;
        this.modelo = modelo;
        this.año = año;
        this.placa = placa;
    ...
    public static class Builder {
        ...
        public VehiculoUpdateRequestDTO build() {
            return new VehiculoUpdateRequestDTO(marca, modelo, año, placa, precio, tipo, disponible);
        }
    }
